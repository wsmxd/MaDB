...
- PostgreSQL: Full (query, schema, import/export) - uses `Npgsql`
...
- PostgreSQL: `NpgsqlConnectionStringBuilder` for connection strings, `GENERATED BY DEFAULT AS IDENTITY` for auto-increment
